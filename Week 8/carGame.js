...
function main(){
    ...
    if(gameOver){
        ...
        ctx.fillText("press Space to Start", canvas.width/2 - 130, canvas.height/2);
    }
...
function drawResults(){
    if(carPos > finish){
        ...
        ctx.font = "25px Arial";
        ctx.textAllign = "center";
        ctx.fillText("You Made it to the finish... you win!", canvas.width/2 -210, canvas.height/2);
    }
    else
    {
        ctx.fillStyle = "black";
        ctx.font = "25px Arial";
        ctx.textAllign = "center";
        ctx.fillText("You ran out of fuel! you absolute loser!", canvas.width/2 -210, canvas.height/2);
    }
}
...
function drawStartTimer(){
    ...
    ctx.font = "25px Arial";
    ctx.textAllign = "center";
    ctx.fillText(seconds, canvas.width/2 -210, canvas.height/2);
}
